        ...
        model: "gpt-3.5-turbo",
          messages: [
            ...
            1. Suggest a correct legal service containing two attributes:\
                        Type of Service (required): Choose from [lawyer, notary, paralegal, arbitrator, mediator].\
                                    Specialization (optional): Choose from [commercial, corporate, criminal, civil, litigation, family, accident, insurance, banking, claims, form, stamp duty, dispute].\
            ...
            End your answer with the following sentence: You can use NyayBazaar's Legal Services button above to filter the legal service providers on our website using these tags.\
